...
using MovieWatchr.Library.Commands;
...
namespace MovieWatchr.Library.Helpers
{
    /// <summary>
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        public NavigationHelper(Page page)
        {
            ...
            Page.Loaded += (sender, e) =>
            {
                ...
                if (Page.ActualHeight != Window.Current.Bounds.Height || Page.ActualWidth != Window.Current.Bounds.Width) return;
        ...
        /// </returns>
        public virtual bool CanGoBack(object parameter)
        {
        ...
        /// </returns>
        public virtual bool CanGoForward(object parameter)
        {
